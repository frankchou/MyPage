...
export default function ResumeAbout() {
  ...
  const bodyText = t('resume.aboutBody');
    ...
    <section ref={sectionRef} className="bg-black py-20 md:py-32 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="bg-[#101010] rounded-2xl md:rounded-3xl p-8 md:p-16 text-center">
          <p className="text-primary text-[10px] sm:text-xs uppercase tracking-widest mb-8">{t('resume.aboutLabel')}</p>
          ...
          <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl max-w-3xl mx-auto leading-[0.95] sm:leading-[0.9] mb-12" style={{ color: '#E1E0CC' }}>
            <WordsPullUpMultiStyle
              segments={[
                { text: t('resume.aboutHeading.seg1'), className: 'font-normal' },
                { text: t('resume.aboutHeading.seg2'), className: 'italic font-serif' },
                { text: t('resume.aboutHeading.seg3'), className: 'font-normal' },
              ]}
